...
export const dict: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'tool.chiSquared.remove': 'Remove',
    'tool.chiSquared.calculate': 'Calculate',
    'tool.chiSquared.statistic': 'Chi-squared (χ²)',
    'tool.chiSquared.df': 'Degrees of freedom',
    'tool.chiSquared.pValue': 'p-value',
  ...
  zh: {
    ...
    'tool.chiSquared.observed': '观测值',
    'tool.chiSquared.expected': '期望值',
    'tool.chiSquared.addRow': '添加行',
    'tool.chiSquared.remove': '删除',
    'tool.chiSquared.calculate': '计算',
    'tool.chiSquared.statistic': '卡方值 (χ²)',
    'tool.chiSquared.df': '自由度',
    ...
    'review.pros': '优点',
    'review.cons': '缺点',
    'review.verdict': '一句话总结',
    'review.bestFor': '适合人群',
    'review.alternatives': '替代方案',
    'review.testedBy': '评测员',
    'review.testedDate': '测试日期',
    'review.lastUpdated': '最后更新',
    'review.basedOn': '基于6维实测模型',
    'review.visitOfficial': '访问官网 →',
    'comment.userComments': '用户评论',
    'comment.hot': '最热',
    'comment.newest': '最新',
    'comment.nickname': '你的昵称（可选）',
    'comment.placeholder': '用过这个工具？分享你的真实体验...',
    'comment.localStorage': '评论将保存在本地，刷新后仍可见',
    'comment.submit': '提交评论',
    'comment.reply': '回复',
    'comment.writeReply': '写下你的回复...',
    'comment.anonymous': '匿名用户',

    'resources.relatedTools': '相关工具推荐',
    'resources.fromReview': '来自 AIHues 评测',
