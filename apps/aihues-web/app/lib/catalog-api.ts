...
const LOCAL_FALLBACK_GAMES: CatalogGame[] = [
  ...
  },
  {
    ...
    icon: 'FL',
    name: 'Flappy',
    description: 'Flap through the gaps and chase your best',
    status: 'ITEM_STATUS_PUBLISHED',
    sortOrder: 6,
    priceTag: 'free',
    externalUrl: '',
  ...
  },
  {
    ...
    icon: 'BB',
    name: 'Brick Breaker',
    description: 'Bounce, break every brick, clear the board',
    status: 'ITEM_STATUS_PUBLISHED',
    sortOrder: 8,
    priceTag: 'free',
    externalUrl: '',
  ...
  },
  {
    ...
    icon: 'FS',
    name: 'Fruit Slash',
    description: 'Swipe to slice the fruit — dodge the bombs',
    status: 'ITEM_STATUS_PUBLISHED',
    sortOrder: 9,
    priceTag: 'free',
    externalUrl: '',
  ...
  },
  {
    ...
    icon: 'SU',
    name: 'Sudoku',
    description: 'Fill the grid — every row, column and box 1–9',
    status: 'ITEM_STATUS_PUBLISHED',
    sortOrder: 11,
    priceTag: 'free',
    externalUrl: '',
  ...
  },
  {
    ...
    icon: 'SK',
    name: 'Sky Strike',
    description: 'Blast through enemy waves and the boss',
    status: 'ITEM_STATUS_PUBLISHED',
    sortOrder: 12,
    priceTag: 'free',
    externalUrl: '',
  ...
  },
  {
    ...
    icon: 'BS',
    name: 'Bullet Storm',
    description: 'Weave through the bullet hell — survive',
    status: 'ITEM_STATUS_PUBLISHED',
    sortOrder: 13,
    priceTag: 'free',
    externalUrl: '',
  ...
  },
  {
    ...
    icon: 'DA',
    name: 'Dodge Arena',
    description: 'Dodge the barrage, trigger skills, stay alive',
    status: 'ITEM_STATUS_PUBLISHED',
    sortOrder: 14,
    priceTag: 'free',
    externalUrl: '',
  ...
  },
  {
    ...
    icon: 'HF',
    name: 'Hundred Floors',
    description: 'Drop floor by floor — mind the ceiling',
    status: 'ITEM_STATUS_PUBLISHED',
    sortOrder: 15,
    priceTag: 'free',
    externalUrl: '',
  ...
  },
  {
    ...
    icon: 'DC',
    name: 'Depth Charge',
    description: 'Drop charges and sink the targets below',
    status: 'ITEM_STATUS_PUBLISHED',
    sortOrder: 16,
    priceTag: 'free',
    externalUrl: '',
  ...
  },
  {
    ...
    icon: 'CR',
    name: 'Combo Rush',
    description: 'Nail the timed inputs and chain combos',
    status: 'ITEM_STATUS_PUBLISHED',
    sortOrder: 17,
    priceTag: 'free',
    externalUrl: '',
  ...
  },
  {
    ...
    icon: 'RS',
    name: 'Radish Smash',
    description: 'Whack the radishes as they pop — beat the clock',
    status: 'ITEM_STATUS_PUBLISHED',
    sortOrder: 18,
    priceTag: 'free',
    externalUrl: '',
  ...
  },
  {
    ...
    icon: 'GL',
    name: 'Game of Life',
    description: 'Seed cells and watch the colony evolve',
    status: 'ITEM_STATUS_PUBLISHED',
    sortOrder: 19,
    priceTag: 'free',
    externalUrl: '',
