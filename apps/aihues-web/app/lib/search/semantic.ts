...
const CATEGORY_KEYWORDS: Record<string, string> = {
  ...
  image: 'image picture photo editor edit graphics',
...
const TOOL_KEYWORDS: Record<string, string> = {
  ...
  'image-compress': 'image compress shrink reduce optimize size jpeg png webp',
  'image-convert': 'image convert format png jpeg jpg webp transcode',
  'image-resize': 'image resize scale dimensions width height shrink enlarge',
  'image-crop': 'image crop cut trim rotate zoom aspect ratio',
  'exif-viewer': 'exif metadata photo gps camera strip remove privacy',
