...
const STATUS_CODES = [
  ...
  { code: 101, name: 'Switching Protocols', desc: 'The server is switching to a different protocol as requested by the client.' },
  { code: 200, name: 'OK', desc: 'The request has succeeded.' },
  { code: 201, name: 'Created', desc: 'The request has succeeded and a new resource has been created.' },
  { code: 204, name: 'No Content', desc: 'The server successfully processed the request but is not returning any content.' },
  { code: 301, name: 'Moved Permanently', desc: 'The requested resource has been permanently moved to a new URL.' },
  { code: 302, name: 'Found', desc: 'The requested resource temporarily resides under a different URL.' },
  { code: 304, name: 'Not Modified', desc: 'The resource has not been modified since the version specified by the request headers.' },
  ...
  { code: 409, name: 'Conflict', desc: 'The request could not be completed due to a conflict with the current state.' },
